...
def test_sync_notes_should_return_no_items_to_parse_when_no_txt_files(init_data_folder: Path):
...
def test_sync_notes_should_return_success_message_when_txt_files_are_parsed(init_data_folder: Path):
